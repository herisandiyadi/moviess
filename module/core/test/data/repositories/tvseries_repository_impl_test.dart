...
import 'package:core/data/models/t_episodetoair_model.dart';
...
import '../../../../tv/test/dummy_data/dummy_tv_objects.dart';
...
void main() {
  ...
  group('Tv Series :  Detail', () {
    ...
    final tTvDetailModel = TvDetailModel(
      ...
      genres: const [TVGenreModel(id: 16, name: "Animation")],
      homepage: '',
      id: 2,
      inProduction: false,
      languages: const ["en"],
